...
const Login = async (email, password)=>{
    const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEVELOPMENT_API_URL"]}/auth/login`, {
        method: "POST",
        headers: {
...
function Home() {
    ...
    const HandleSubmit = async (e)=>{
        ...
        // }
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(formData.email, formData.password);
...
_s(Home, "0ziudH88uSJVDeF4/PPFWqhnGj4=", false, function() {
    return [
...
//# sourceMappingURL=_bd42ef48._.js.map